...
export async function PracticeDetailContent({ area }: { area: PracticeArea }) {
  ...
  return (
    <section className="bg-ivory px-5 py-12 md:px-[72px] md:py-20">
      <div className="max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-10 md:gap-16">
        <div>
          <Eyebrow className="mb-5">{t("overview")}</Eyebrow>
        ...
        <aside>
          <Eyebrow className="mb-5">{t("howWeHelp")}</Eyebrow>
          <h2 className="sr-only">{t("howWeHelp")}</h2>
